...
class ViewDataWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.title_label = QLabel("Список студентов")
    ...
    def edit_selected_student(self):
        if self.selected_student_id:
            ...
            QMessageBox.warning(self, "Ошибка!", "Пожалуйста, выберите студента для редактирования")
    ...
    def delete_selected_student(self):
        if self.selected_student_id:
            ...
            if reply == QMessageBox.StandardButton.Yes:
                ...
                if success:
                    QMessageBox.information(self, "Выполнено!", "Студент успешно удален")
                    self.load_data()
                else:
                    QMessageBox.warning(self, "Ошибка!", "Не удалось удалить студента")
        else:
            QMessageBox.warning(self, "Предупреждение", "Пожалуйста, выберите студента для удаления")